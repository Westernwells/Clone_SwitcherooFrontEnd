...
import "./personalDetails2.1a.css";

const { Option } = Select;
function PersonalDetails2p1a(props) {
    ...
    <div className="personal-details2p1s">
      <Row className="d-row-s1">
        <Col lg={24}>
          ...
          <h6 className="h61">What is your current address?</h6>
        </Col>
        <Col lg={24}>
        ...
        <Col lg={24} className="q1">
          ...
          >
            <input
              ...
              value="tenant"
            />
            <label for="areyou1">tenant</label>
          </div>
          <div
            onClick={clickRadio}
            className={
          ...
          >
            <input
              ...
              className=""
              value="living with relatives/friends"
            />
            <label for="areyou2">living with relatives/friends</label>
          </div>
        </Col>
        <Col lg={24}>
        ...
        <Col lg={24}>
          <h6 className="h61">
            Are there any other persons over the age of 17 who will occupy the
            house?
          </h6>
        </Col>
        <Col lg={24}>
          <div>
            <Select
              className={
                questions.numberOfOccupyer
                  ? "select-option1 bg-o"
                  : "select-option1"
              }
              defaultValue="Select from options"
              onChange={handleOccuoyers}
            >
              {occupyers.map((value, index) => {
                return (
                  <Option key={index} value={value}>
                    {value}
                  </Option>
          ...
          return (
            <>
              <Col lg={24}>
                <h6 className="h61">
                  Full name{" "}
                  {index === 1 ? " of " + (index + 1) + "nd person" : ""}
                  {index === 2 ? "of " + (index + 1) + "rd person" : ""}
                  {index > 2 ? "of " + (index + 1) + "th person" : ""}
                </h6>
              </Col>
              ...
              <Col lg={24}>
                <h6 className="h61">Date of birth</h6>
              </Col>

              <Col lg={24} className="q1">
                <div
                  className={
                    questions.DOBPerson1
                      ? "input2 input2simple bg-o"
                      : "input2 input2simple"
                  }
                >
                  <DatePicker onChange={e => onChange(e, "DOBPerson1")} />
                </div>
              </Col>
              <Col lg={24}>
                <h6 className="h61">Relationship with applicant</h6>
              </Col>
              <Col lg={24}>
                <div>
                  <Select
                    className={
                      questions.relationWithApplicant
                        ? "select-option1 bg-o"
                        : "select-option1"
                    }
                    defaultValue="Select from options"
                    onChange={handleRelationWith}
                  >
...
export default PersonalDetails2p1a;
