...
import "./incomDetailsSE.css";

const { Option } = Select;
function IncomeDetailsSE(props) {
  ...
  return (
    <div className="incom-details-se">
      <Row className="d-row-s1">
        <Col lg={24}>
          <h1 className="heading1">
            We need some details on your business's performance with your last three years of accounts
          </h1>
        </Col>
        <Col lg={24}>
        ...
        <Col lg={24}>
          <Row className="th-row">
            ...
            <Col className="th" lg={6}>Last year of audited accounts</Col>
            <Col className="th" lg={6}>Previous year -1</Col>
            <Col className="th" lg={6}>Previous year -2</Col>
          </Row>
        </Col>
        <Col lg={24}>
        ...
        <Col lg={24}>
          <Row className="details-row">
            <Col className="" lg={6}>
              <h6 className="h6-d dl">
                Average last 3 years Trading profit
              </h6>
            </Col>
            <Col className="" lg={6}>
...
export default IncomeDetailsSE;
