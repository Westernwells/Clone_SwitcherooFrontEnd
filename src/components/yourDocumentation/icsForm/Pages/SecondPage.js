  ...
  return (
    <>
      <div className="pageHeight -mt-6">
        <div className="elements-container color-primary mt-10 ">
          <Logo />
        ...
        <MegaHeading headingTitle="Current Housing Details" headingNumber="2" />
        <div className="elements-container mt-6">
          <DefaultRow
            ...
            inputHeight="250px"
          />
          <DefaultRow title="If you are currently renting, please state your current monthly rent" />
        </div>
      </div>
    </>
  );
