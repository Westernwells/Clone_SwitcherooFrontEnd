	...
	return (
		<>
			<div className="pageHeight -mt-2">
				<TopPageLogo />
				<div className="elements-container text-xs ">
					<h1 className="red-border color-primary font-semibold text-lg mt-4">
						Data Protection Notice
					</h1>
					<h4 className="font-semibold text-sm mt-4">Data Controller</h4>
					...
					<h4 className="font-semibold text-sm mt-4">Information we Collect</h4>
					<p className="text-gray-800">
					...
					<ul className="list-disc mt-2 text-gray-800">
						...
						<li className="px-6">your marital status;</li>
						<li className="px-6">your financial associations;</li>
						<li className="px-6">
					...
					<h4 className="font-semibold text-sm mt-4">Information We Need</h4>
					<p className="text-gray-800">
						If you do not provide certain information we may not be able to:
						<br />
					</p>
					<ul className="list-disc text-gray-800">
						<li className="px-6">assess your loan application;</li>
						<li className="px-6">
						...
						<li className="px-6">assess suitability</li>
					</ul>
					<p className="text-gray-800">
