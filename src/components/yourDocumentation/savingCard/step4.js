...
class StepFour extends Component {
  ...
  onUploadFiles = applicant => {
    ...
    for (let i = 0; i < count; i++) {
      ...
      data.append("applicantTile", "savingDeposits");
          ...
          <div className="container">
            ...
            <div className="row p-3">
              <div className="col-md-5 text-right">
                <img className="" src={SavingIcon} width={75} alt="" />
                {/* <i className="fas fas fa-coins fac fa-6x"></i> */}
              </div>
              <div className="col-md-6 text-left pt-1">
            ...
            <div className="row p-2 m-4">
              ...
              <div className="col-md-12">
                <div className="wrn-bx">
                  <span>
                    Please provide 6 months history for all savings and
                    investment accounts
                  </span>
                </div>
              </div>
