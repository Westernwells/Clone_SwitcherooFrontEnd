...
const SixteenthPage = () => {
	return (
		<>
			<div className="pageHeight -mt-2" style={{ "--bottom": "55px" }}>
				<TopPageLogo />
				<div className="elements-container sepa mt-6  text-grey-900">
					<h4 className="font-semibold mb-4">SEPA Direct Debit Mandate</h4>
					...
					<div className="flex justify-start items-start w-full mt-2">
						...
						<div className="3/5" style={{ marginLeft: "11.2%" }}>
							<RadioButton />
						</div>
					</div>
